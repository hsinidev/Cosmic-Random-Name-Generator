<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Cosmic%20Random%20Name%20Gener&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Cosmic Random Name Generator Header Banner" />

  <h1>🚀 Cosmic Random Name Generator</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/Cosmic-Random-Name-Generator"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Cosmic Random Name Generator** is a production-grade **TypeScript** platform engineered for high reliability, clean architectural separation, and frictionless developer workflow.
...
```bash
git clone https://github.com/hsinidev/Cosmic-Random-Name-Generator.git
cd Cosmic-Random-Name-Generator
```
